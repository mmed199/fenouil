        ...
        $ ( '#setting-page-container' ).on ( 'change', 'select.adding-type-field', function () {
            ...
            switch ( $optionValue ) {
                ...
                case "check":
                    ...
                    '<input type="text" class="extra-dropdown-fields-label" value="" placeholder="Label" name="woocommerce_extra_fields_setting_name[' + ($counterContainer - 1) + '][][woocommerce_extra_fields_setting_name_label]">' +
                    '<input type="text" class="extra-dropdown-fields-value" value="" placeholder="Value" name="woocommerce_extra_fields_setting_name[' + ($counterContainer - 1) + '][][woocommerce_extra_fields_setting_name_value]">' +
